<nav class="flex items-center justify-between flex-wrap bg-blue-dark p-6">
    <div class="flex items-center flex-no-shrink text-white mr-6">
        ...
        <span class="font-semibold text-xl tracking-tight">Guess Song</span>
    </div>
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
            <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue hover:bg-white mt-4 lg:mt-0">Download</a>
        </div>
    </div>
</nav>